    ...
    switch (special) {
      ...
      case 2:
        ...
        if(position != -1 && !doors[position].getOpen()){
          ...
          Bullet temp_bullet(player.getX(), player.getY(), DIR_UP, player.getId());
    ...
    switch (special) {
      ...
      case 2:
        ...
        if(position != -1 && !doors[position].getOpen()){
          ...
          Bullet temp_bullet(player.getX(),player.getY(), DIR_DOWN, player.getId());
          bullets.push_back(temp_bullet);
          action = true;
        }
        break;
    ...
    switch (special) {
      ...
      case 2:
        ...
        if(position != -1 && !doors[position].getOpen()){
          ...
          Bullet temp_bullet(player.getX(), player.getY(), DIR_LEFT, player.getId());
          bullets.push_back(temp_bullet);
          action = true;
        }
        break;
    ...
    switch (special) {
      ...
      case 2:
        ...
        if(position != -1 && !doors[position].getOpen()){
          ...
          Bullet temp_bullet(player.getX(), player.getY(), DIR_RIGHT, player.getId());
          bullets.push_back(temp_bullet);
          action = true;
        }
        break;
